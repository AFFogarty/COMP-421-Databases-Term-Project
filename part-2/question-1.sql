...
Relations:
    ...
    SufferingFrom( patient_id , ill_name , ill_since, ill_until, insurance_coverage,
    treatment_cost, urgency)
    Treats( staff_id , patient_id , since)
    WorksFor( staff_id , dept_name , wages, over_time, contract_until, salary,
    contract_from)